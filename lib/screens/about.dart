      ...
      appBar: AppBar(
        leading: InkWell(
          onTap: () => Navigator.of(context).pop(),
            child: Icon(Icons.arrow_back, color: Color(0xff426D51),)),
        title: Text("About Aayu", style: GoogleFonts.poppins(
          textStyle: TextStyle(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text(
                'Aayu, in its second release version 2.0, has the capability to identify and classify the following 10 classes of medicinal plants: Aloe vera, Amruthabali, Arali, Castor, Mango, Mint, Neem, Sandalwood, and Turmeric.\nAs we continue to train our model with more classes, future updates of Aayu will expand its ability to identify additional medicinal plants and raw materials.',
                style: GoogleFonts.poppins(
                  textStyle: TextStyle(
                    fontWeight: FontWeight.w400,
                    fontSize: 16,
